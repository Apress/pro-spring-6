...
*NOTE:* This project requires https://www.docker.com[*Docker*] installed. The JOOQ subprojects require the MariaDB container to be up and running in order for sources to be generated. The project does not compile without the generated sources.
