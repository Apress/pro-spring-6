 ...
 */
public class RecordsJdbcDemo {
    private static final Logger LOGGER = LoggerFactory.getLogger(RecordsJdbcDemo.class);

    private static final SingerDao singerDao = new RecordSingerDao();
    ...
    public static void main(String... args) {
        ...
        var singer = new Singer(null,"Ed","Sheeran", LocalDate.of(1991,2, 17), Set.of());
